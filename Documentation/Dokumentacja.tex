...
\multirow{4}{*}{Przebieg} 
& Należy wybrać opcję 'Sign up'. \\
& Należy podać imię, nazwisko, email, hasło oraz opcjonalnie wypełnić dodatkowe pola \\
& Należy zatwierdzić formularz \\
& Na email zostanie przesłany link potwierdzający rejestrację, który należy kliknąć \\
\hline
\end{longtable} 
...
\multirow{3}{*}{Przebieg} 
& Należy wybrać opcję 'Sign in'. \\
& Należy podać email oraz hasło \\
& Należy zatwierdzić dane \\
\hline
\end{longtable} 
...
\multirow{3}{*}{Przebieg} 
& Należy wybrać opcję 'Settings' oraz 'Profile'. \\
& Należy wybrać interesujące nas dane, które chcemy zmienić i wybrać opcję 'Edit' \\
& Po wprowadzeniu danych należy zatwierdzić zmiany \\
\hline
\end{longtable} 
...
\multirow{2}{*}{Przebieg} 
& Należy wybrać opcję 'Books' \\
& Należy wypełnić jeden/kilka filtrów: filtr imion autorów ('Name'), nazwisk autorów ('Surname'), tytułów ('Title'), tagów ('Tag') \\
\hline
\end{longtable} 
...
\multirow{3}{*}{Przebieg} 
& Należy wybrać opcję 'Books' i 'Add book' \\
& Należy uzupełnić formularz, podając imię i nazwisko autora, tytuł książki i opcjonalnie wypełnić pozostałe pola \\
& Należy zatwierdzić formularz \\
\hline
\end{longtable} 
...
\multirow{4}{*}{Przebieg} 
& Należy wybrać opcję 'Books' \\
& Należy wybrać daną książkę poprzez 'See details' \\
& Należy wybrać interesujące nas dane, które chcemy zmienić i wybrać opcję 'Edit' \\
& Po wprowadzeniu danych należy zatwierdzić zmiany \\
\hline
\end{longtable}
...
& W dodatkowym oknie należy potwierdzić chęć usunięcia danej pozycji (opcja 'Yes') \\
\hline
\end{longtable}
...
\multirow{3}{*}{Przebieg} 
& Należy wybrać opcję 'Books' \\
& Należy wybrać daną pozycję \\
& Należy wybrać ikonę książki \\
\hline
\end{longtable}
