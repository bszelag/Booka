...
/books/<book\_id> & UPDATE & Zmiana danych książki & curl -X UPDATE http://localhost/books/12 -d \{'title':'xyz','author':'xyz',...\} \\ \hline
...
/books/<book\_id>/lend/ & UPDATE & Edycja danych o wypożyczeniu & curl -X POST http://localhost/books/12/lend -d \{"to":"abc","date":"null","info":" "\} \\ \hline
...
Endpoint & Request & Opis & Przykład użycia \\ \hline
/search/<query> & GET & Wyszukiwanie & curl -X GET http://localhost/search/<query> \\ \hline
\end{longtable} 
