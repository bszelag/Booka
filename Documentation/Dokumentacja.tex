...
/users/<user\_id> & PUT & Zmiana danych użytkownika & curl -X PUT http://localhost/users/12 -d \{'login':'xyz','password':'xyz'\} \\ \hline
/users/<user\_id> & DELETE & Usuwanie konta użytkownika & curl -X DELETE http://localhost/users/12 \\ \hline
/users/sign\_in & GET & Wyświetlanie strony logowania & curl -X GET http://localhost/users/sign\_in \\ \hline
...
Endpoint & Request & Opis & Przykład użycia \\ \hline
/books/ & GET & Pobranie informacji o książkach & curl -X GET http://localhost/books/ \\ \hline
/books/<book\_id> & GET & Wyświetlanie informacji o danej książce & curl -X GET http://localhost/books/12 \\ \hline
/books/<book\_id> & PUT & Zmiana danych książki & curl -X PUT http://localhost/books/12 -d \{'title':'xyz','author':'xyz',...\} \\ \hline
/books/<book\_id> & DELETE & Usuwanie książki & curl -X DELETE http://localhost/books/12 \\ \hline
/books/<book\_id>/lend/ & GET & Wyświetla informacje o wypożyczeniu & curl -X GET http://localhost/books/12/lend \\ \hline
/books/<book\_id>/lend/ & POST & Wypożyczanie książki & curl -X POST http://localhost/books/12/lend -d \{"to":"abc","date":"null","info":" "\} \\ \hline
/books/<book\_id>/lend/ & PUT & Edycja danych o wypożyczeniu & curl -X POST http://localhost/books/12/lend -d \{"to":"abc","date":"null","info":" "\} \\ \hline
/books/<book\_id>/lend/ & DELETE & Usuwa dane wypożyczenie & curl -X DELETE http://localhost/books/lend/12 \\ \hline
\end{longtable} 
...
Endpoint & Request & Opis & Przykład użycia \\ \hline
/search/ & GET & Widok wyszukiwarki & curl -X GET http://localhost/search/ \\ \hline
/search/ & POST & Wyszukiwanie & curl -X POST http://localhost/search/ -d \{"pole1":"a","pole2":"b"...\} \\ \hline
\end{longtable} 
...
\multicolumn{4}{ |c| }{ Biblioteki } \\ 
\multicolumn{4}{ |c| }{ /libraries } \\ \hline
Endpoint & Request & Opis & Przykład użycia \\ \hline
...
/libraries/<id> & PUT & Edycja danych o bibliotece & curl -X PUT http://localhost/libraries/12 -d \{"pole1":"a","pole2":"b"...\} \\ \hline
...
\multicolumn{4}{ |c| }{ Księgarnie } \\ 
\multicolumn{4}{ |c| }{ /bookshops } \\ \hline
Endpoint & Request & Opis & Przykład użycia \\ \hline
...
/bookshops/<id> & PUT & Edycja danych o księgarni & curl -X PUT http://localhost/bookshops/12 -d \{"pole1":"a","pole2":"b"...\} \\ \hline
...
/friends/<id> & POST & Wyślij powiadomienie znajomemu & curl -X PUT http://localhost/friends/12 -d \{"type":"a","message":"b"...\} \\ \hline
